...
tbl_names_popular |> 
  ...
  labs(
    ...
    subtitle = 'Emma and Noah are Most Popular',
    caption = 'Source: Social Security Admin.',
    y = 'Names',
    x = 'Number of Births'
  ) +
  ##REMOVE COMMENTS ON SCALE ADJUSTMENT IN POST
...
tbl_names_by_letter |> 
  ...
  labs(
      title = ("Percent of Babies Born with a Given First Letter"),
      subtitle = ("A is most common for girls, while J is most common for boys"),
      x = 'First Letter',
      y = 'percent births'
    ) +
...
plot_trends_in_letter <- function(my_letter) {
  tbl_names_by_letter |> 
    ...
    labs(
      ...
      subtitle = "Trends show some similar peaks near early 1940s and late 1970s",
      caption = "Souce: Social Security Admin",
      x = "Year",
      y = 'Percent Births'
    ) +
...
tbl_names_by_first_and_last_letter |> 
 ...
 labs(
   title="Heatmap of First and Last Letters of Names",
   subtitle="Highest Correlation with A and A",
   x='First Letter',
   y='Last Letter',
