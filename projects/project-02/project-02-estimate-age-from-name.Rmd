...
tbl_names <- readr::read_csv(
  file = "C:/Users/Josiah/Desktop/Practice Data/names.csv.gz", 
...
tbl_lifetables <- readr::read_csv(
  file = "C:/Users/Josiah/Desktop/Practice Data/lifetables.csv.gz", 
  show_col_types = FALSE
)
...
tbl_lifetables |> 
  ...
  labs(
    title = "Probability of Being Alive by Birth Year",
    subtitle = "A slightly grim concept",
    x = "Birth Year",
    y = "Probability of Not Being Dead",
    caption = "Source: SSA"
  ) +
...
tbl_lifetables_extended_2022 |> 
  ...
  labs(
    title = "Probability of Being Alive by Birth Year",
    subtitle = "This time with a line instead of a step",
    x = "Birth Year",
    y = "Probability of Not Being Dead",
    caption = "Source: SSA"
  )
...
plot_estimated_age <- function(tbl, my_name, my_sex) {
  tbl |> 
    ...
    geom_col(aes(y = nb_alive, color = "chartreuse4"))+
    # Add a line layer with y = nb_births, and appropriate colors
    geom_line(aes(y = nb_alive, color = "bisque2"))+
    ...
    labs(
      ...
      subtitle = "How many people sharing this name are alive from each year",
      x = "Birth year",
      y = "Number of people sharing that name"
    ) +
...
tbl_names_extended_age |> 
  ...
  # Add labels (title, subtitle, x, y)
  labs(
    title = "Age Distributions by Name",
    subtitle = "Median denoted in green",
    x = "Age Distribution",
    y = "Name"
  ) +
